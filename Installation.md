...
```
- Dans certains cas, il peut y avoir des chemins de commandes manquants au PATH. La commande ***export*** permet d'ajouter ces répertoires au PATH du shell.
```
...
### 2. Installation des paquets principaux
